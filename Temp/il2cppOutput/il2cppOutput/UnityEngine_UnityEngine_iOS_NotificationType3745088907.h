...
struct  NotificationType_t3745088907 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(NotificationType_t3745088907, ___value___1)); }
